...
return [
    ...
    'rum' => [
        ...
        'typical_value'         => 'Typical (75% of users)',
        'empty' => [
    ...
    'queries' => [
        ...
        'subtitle'                => 'How many database queries each route runs, and how long they take. Click a route to see affected URLs and repeated SQL patterns.',
        'baseline_title'          => 'Queries per route',
        'baseline_subtitle'       => 'Routes are sorted from worst to best. A red badge means many queries; a yellow badge means a moderate amount.',
        'memory_hogs_title'       => 'Memory-hungry routes',
        'memory_hogs_subtitle'    => 'Top 5 routes by typical peak memory usage.',
        'regression'              => 'regression',
        'n_plus_one_badge'        => 'N+1',
        'legend'                  => 'Typical = what most requests look like. Worst case = the heaviest 5%. Click any row for SQL patterns.',
        'col_route'               => 'Route',
        'col_samples'             => 'Samples',
        'col_typical_queries'     => 'Typical queries',
        'col_worst_queries'       => 'Worst case',
        'col_typical_time'        => 'Typical time',
        'col_worst_time'          => 'Worst time',
        'detail_heading'          => 'Route details',
        'affected_urls'           => 'URLs that hit this route',
        'recent_audits'           => 'Recent audits',
        'top_patterns'            => 'Repeated SQL patterns',
        'audits_short'            => 'audits',
        'empty' => [
    ...
    'seo' => [
        ...
        'status_skip'         => 'N/A',
        'page_title'          => 'SEO',
        'page_subtitle'       => 'Search visibility checks across your monitored URLs',
        'lighthouse_score'    => 'Lighthouse SEO',
        'custom_score'        => 'Custom checks',
        'failing_checks'      => 'failing',
        'top_failing'         => 'Top failing checks',
        'avg_score'           => 'Average SEO score',
        'urls_with_failures'  => 'URLs with failures',
        'urls_label'          => 'URLs',
        'per_url_title'       => 'Per-URL SEO scores',
        'categories' => [
        ...
        'checks' => [
            'noindex' => [
                ...
                'description' => 'noindex directive prevents Google from indexing this page.',
                'hint'        => 'Remove the <meta name="robots" content="noindex"> tag or X-Robots-Tag: noindex header.',
            ],
            'nofollow' => [
                'title'       => 'Page links are followable',
                'description' => 'A nofollow directive prevents Google from following links on this page.',
                'hint'        => 'Remove nofollow from the robots meta tag unless intentionally blocking link equity.',
            ],
            'robots-txt-indexable' => [
                'title'       => 'robots.txt allows indexing',
                'description' => 'Googlebot is blocked from crawling this page via robots.txt.',
                'hint'        => 'Update your robots.txt to allow Googlebot to access this path.',
            ],
            'h1' => [
                'title'        => 'H1 heading present and unique',
                'description'  => 'Each page should have exactly one H1 heading that describes the page content.',
                'hint'         => 'Add a single, descriptive H1 element near the top of the page.',
                'hint_multiple' => 'Reduce H1 elements to exactly one per page.',
            ],
            'https-links' => [
                'title'       => 'All resources use HTTPS',
                'description' => 'HTTP resources on an HTTPS page cause mixed content and harm trust.',
                'hint'        => 'Update all resource URLs to use https://.',
            ],
            'image-alt' => [
                'title'       => 'All images have alt text',
                'description' => 'Images without alt text are invisible to search engines and screen readers.',
                'hint'        => 'Add descriptive alt attributes to all meaningful images.',
            ],
            'broken-links' => [
                'title'       => 'No broken links',
                'description' => 'Broken links return 4xx/5xx responses, degrading user experience and crawl efficiency.',
                'hint'        => 'Fix or remove the broken links listed above.',
            ],
            'broken-images' => [
            ...
            'meta-description' => [
                ...
                'hint'        => 'Add a <meta name="description" content="..."> tag to the <head>.',
                'hint_long'   => 'Shorten your meta description to under 160 characters.',
            ],
            'title-length' => [
                'title'       => 'Title tag length',
                'description' => 'Page titles longer than 60 characters are often truncated in search results.',
                'hint'        => 'Write a concise, descriptive <title> of under 60 characters.',
                'hint_long'   => 'Shorten your page title to under 60 characters.',
            ],
            'og-image' => [
                'title'       => 'Open Graph image set',
                'description' => 'An og:image meta tag ensures a preview image appears when the page is shared on social networks.',
                'hint'        => 'Add <meta property="og:image" content="https://..."> to your <head>.',
            ],
            'html-lang' => [
                'title'       => 'HTML lang attribute set',
                'description' => 'The lang attribute helps search engines and screen readers determine the page language.',
                'hint'        => 'Add lang="en" (or the appropriate BCP47 code) to your <html> element.',
            ],
            'canonical' => [
                'title'       => 'Canonical URL declared',
                'description' => 'A canonical tag tells Google the authoritative URL and prevents duplicate-content penalties.',
                'hint'        => 'Add <link rel="canonical" href="https://..."> to your <head>.',
            ],
            'structured-data' => [
                'title'       => 'Structured data (JSON-LD)',
                'description' => 'JSON-LD structured data enables rich results in Google Search.',
                'hint'        => 'Add a <script type="application/ld+json"> block with Schema.org markup.',
                'hint_invalid' => 'Fix the JSON syntax errors in your JSON-LD blocks.',
            ],
            ...
            'ttfb' => [
                ...
                'description' => 'High Time to First Byte delays LCP and page experience scores.',
                'hint'        => 'Enable OPcache, config/route cache, and use Redis for sessions.',
            ],
            'status-code' => [
                'title'       => 'HTTP 200 response',
                'description' => 'Pages returning error codes cannot be indexed by search engines.',
                'hint'        => 'Ensure the page returns a 200 OK response.',
                'hint_redirect' => 'Consider consolidating redirects to reduce latency.',
            ],
            'html-size' => [
                'title'       => 'HTML size within limit',
                'description' => 'Excessively large HTML documents slow parsing and waste crawl budget.',
                'hint'        => 'Remove unnecessary markup, inline scripts, or inline data from the HTML.',
            ],
            'image-size' => [
                'title'       => 'No oversized images',
                'description' => 'Large images hurt LCP and increase page weight for mobile visitors.',
                'hint'        => 'Compress images and serve them in modern formats (WebP, AVIF).',
            ],
            'js-size' => [
                'title'       => 'No oversized JavaScript files',
                'description' => 'Large JS bundles delay Time to Interactive and harm page experience.',
                'hint'        => 'Code-split large bundles with Vite\'s manualChunks or dynamic imports.',
            ],
            'css-size' => [
                'title'       => 'No oversized CSS files',
                'description' => 'Large stylesheets are render-blocking. (Default threshold 15 KB is opinionated — adjust for your project.)',
                'hint'        => 'Purge unused CSS with Tailwind\'s content config and enable compression.',
            ],
            'compression' => [
    ...
    'url_detail' => [
        ...
        'link_latest_audit'      => 'Latest audit',
        'link_seo'               => 'SEO checks',
        'link_queries'           => 'Database queries',
    ...
    'issue_detail' => [
        ...
        'n_plus_one_banner'      => 'N+1 query patterns repeat the same SQL many times per request. See per-route patterns and affected URLs in the Database queries page.',
        'n_plus_one_cta'         => 'View database queries',
    ],
    'budgets_page' => [
