...
return [
    ...
    'rum' => [
        ...
        'typical_value'         => 'Typisch (75 % der Nutzer)',
        'empty' => [
    ...
    'queries' => [
        ...
        'subtitle'                => 'Wie viele Datenbankabfragen jede Route ausführt und wie lange sie dauern. Klicken Sie auf eine Route, um betroffene URLs und wiederholte SQL-Muster zu sehen.',
        'baseline_title'          => 'Abfragen pro Route',
        'baseline_subtitle'       => 'Routen werden vom schlechtesten zum besten sortiert. Rotes Abzeichen = viele Abfragen, gelbes Abzeichen = moderat.',
        'memory_hogs_title'       => 'Speicherintensive Routen',
        'memory_hogs_subtitle'    => 'Top 5 Routen nach typischem Spitzenspeicher.',
        'regression'              => 'Regression',
        'n_plus_one_badge'        => 'N+1',
        'legend'                  => 'Typisch = was die meisten Anfragen aussehen. Worst case = die schwersten 5 %. Klicken Sie auf eine Zeile für SQL-Muster.',
        'col_route'               => 'Route',
        'col_samples'             => 'Stichproben',
        'col_typical_queries'     => 'Typische Abfragen',
        'col_worst_queries'       => 'Worst case',
        'col_typical_time'        => 'Typische Zeit',
        'col_worst_time'          => 'Worst-Zeit',
        'detail_heading'          => 'Route-Details',
        'affected_urls'           => 'URLs, die diese Route treffen',
        'recent_audits'           => 'Letzte Audits',
        'top_patterns'            => 'Wiederholte SQL-Muster',
        'audits_short'            => 'Audits',
        'empty' => [
    ...
    'nav' => [
        'issues'           => 'Probleme',
        'seo'              => 'SEO',
        'group_audit'      => 'Audit-Ergebnisse',
        'group_telemetry'  => 'Live-Telemetrie',
        'group_reference'  => 'Referenz',
    ],
    'pages' => [
        'overview' => [
            'title'    => 'Vitals',
    ...
    'url_detail' => [
        ...
        'link_latest_audit'      => 'Letztes Audit',
        'link_seo'               => 'SEO-Checks',
        'link_queries'           => 'DB-Abfragen',
        'link_rum'               => 'Live-Performance',
    ],
    'insights' => [
    ...
    'issue_detail' => [
        ...
        'n_plus_one_banner'    => 'N+1-Muster wiederholen dieselben SQL-Abfragen vielfach pro Request. Siehe Muster pro Route und betroffene URLs unter DB-Abfragen.',
        'n_plus_one_cta'       => 'DB-Abfragen ansehen',
    ],
    'budgets_page' => [
