...
return [
    ...
    'rum' => [
        ...
        'typical_value'         => 'Típico (75 % de los usuarios)',
        'empty' => [
    ...
    'queries' => [
        ...
        'subtitle'                => 'Cuántas consultas ejecuta cada ruta y cuánto tardan. Haz clic en una ruta para ver las URLs afectadas y los patrones SQL repetidos.',
        'baseline_title'          => 'Consultas por ruta',
        'baseline_subtitle'       => 'Las rutas se ordenan de peor a mejor. Una insignia roja indica muchas consultas; una amarilla indica cantidad moderada.',
        'memory_hogs_title'       => 'Rutas intensivas en memoria',
        'memory_hogs_subtitle'    => 'Top 5 rutas por uso de memoria típico.',
        'regression'              => 'regresión',
        'n_plus_one_badge'        => 'N+1',
        'legend'                  => 'Típico = cómo se ven la mayoría de las solicitudes. Peor caso = el 5 % más pesado. Haz clic en una fila para ver patrones SQL.',
        'col_route'               => 'Ruta',
        'col_samples'             => 'Muestras',
        'col_typical_queries'     => 'Consultas típicas',
        'col_worst_queries'       => 'Peor caso',
        'col_typical_time'        => 'Tiempo típico',
        'col_worst_time'          => 'Peor tiempo',
        'detail_heading'          => 'Detalles de la ruta',
        'affected_urls'           => 'URLs que usan esta ruta',
        'recent_audits'           => 'Auditorías recientes',
        'top_patterns'            => 'Patrones SQL repetidos',
        'audits_short'            => 'auditorías',
        'empty' => [
    ...
    'seo' => [
        ...
        'status_skip'         => 'N/A',
        'page_title'          => 'SEO',
        'page_subtitle'       => 'Verificaciones de visibilidad para todas tus URLs monitorizadas',
        'lighthouse_score'    => 'SEO de Lighthouse',
        'custom_score'        => 'Verificaciones personalizadas',
        'failing_checks'      => 'fallando',
        'top_failing'         => 'Problemas más frecuentes',
        'avg_score'           => 'Puntuación SEO media',
        'urls_with_failures'  => 'URLs con problemas',
        'urls_label'          => 'URLs',
        'per_url_title'       => 'Puntuaciones SEO por URL',
        'categories' => [
            'configuration' => 'Configuración',
            'content'       => 'Contenido',
            'meta'          => 'Meta',
            'performance'   => 'Rendimiento',
            'agentic'       => 'Preparación para agentes',
        ],
        'checks' => [
            'noindex' => [
                'title'       => 'La página es indexable',
                'description' => 'La directiva noindex impide que Google indexe esta página.',
                'hint'        => 'Elimine la etiqueta <meta name="robots" content="noindex"> o el encabezado X-Robots-Tag: noindex.',
            ],
            'nofollow' => [
                'title'       => 'Los enlaces de la página son seguibles',
                'description' => 'Una directiva nofollow impide que Google siga los enlaces de esta página.',
                'hint'        => 'Elimine nofollow de la meta tag robots salvo que sea intencional.',
            ],
            'robots-txt-indexable' => [
                'title'       => 'robots.txt permite la indexación',
                'description' => 'Googlebot está bloqueado por robots.txt en esta ruta.',
                'hint'        => 'Actualice robots.txt para permitir a Googlebot acceder a esta ruta.',
            ],
            'h1' => [
                'title'        => 'Encabezado H1 presente y único',
                'description'  => 'Cada página debe tener exactamente un encabezado H1.',
                'hint'         => 'Agregue un único H1 descriptivo cerca del inicio de la página.',
                'hint_multiple' => 'Reduzca los elementos H1 a exactamente uno por página.',
            ],
            'https-links' => [
                'title'       => 'Todos los recursos usan HTTPS',
                'description' => 'Los recursos HTTP en una página HTTPS generan contenido mixto.',
                'hint'        => 'Actualice todas las URLs de recursos para usar https://.',
            ],
            'image-alt' => [
                'title'       => 'Todas las imágenes tienen texto alt',
                'description' => 'Las imágenes sin atributo alt son invisibles para los motores de búsqueda.',
                'hint'        => 'Agregue atributos alt descriptivos a todas las imágenes significativas.',
            ],
            'broken-links' => [
                'title'       => 'Sin enlaces rotos',
                'description' => 'Los enlaces rotos devuelven respuestas 4xx/5xx, degradando la experiencia.',
                'hint'        => 'Corrija o elimine los enlaces rotos listados arriba.',
            ],
            'broken-images' => [
                'title'       => 'Sin imágenes rotas',
            ...
            'meta-description' => [
                ...
                'hint'        => 'Agregue una etiqueta <meta name="description" content="..."> en el <head>.',
                'hint_long'   => 'Acorte su meta descripción a menos de 160 caracteres.',
            ],
            'title-length' => [
                'title'       => 'Longitud del título',
                'description' => 'Los títulos de más de 60 caracteres suelen truncarse en los resultados.',
                'hint'        => 'Escriba un <title> conciso de menos de 60 caracteres.',
                'hint_long'   => 'Acorte su título a menos de 60 caracteres.',
            ],
            'og-image' => [
                'title'       => 'Imagen Open Graph configurada',
                'description' => 'Una meta tag og:image garantiza que aparezca una imagen de vista previa al compartir.',
                'hint'        => 'Agregue <meta property="og:image" content="https://..."> en su <head>.',
            ],
            'html-lang' => [
                'title'       => 'Atributo lang de HTML configurado',
                'description' => 'El atributo lang ayuda a los motores de búsqueda a determinar el idioma de la página.',
                'hint'        => 'Agregue lang="es" (o el código BCP47 apropiado) a su elemento <html>.',
            ],
            'canonical' => [
                'title'       => 'URL canónica declarada',
                'description' => 'Una etiqueta canonical indica a Google la URL autoritativa.',
                'hint'        => 'Agregue <link rel="canonical" href="https://..."> en su <head>.',
            ],
            'structured-data' => [
                'title'       => 'Datos estructurados (JSON-LD)',
                'description' => 'Los datos estructurados JSON-LD habilitan rich results en Google.',
                'hint'        => 'Agregue un bloque <script type="application/ld+json"> con marcado Schema.org.',
                'hint_invalid' => 'Corrija los errores de sintaxis JSON en sus bloques JSON-LD.',
            ],
            ...
            'ttfb' => [
                ...
                'description' => 'Un TTFB alto retrasa el LCP y las puntuaciones de experiencia de página.',
                'hint'        => 'Active OPcache, config/route cache y use Redis para las sesiones.',
            ],
            'status-code' => [
                'title'       => 'Respuesta HTTP 200',
                'description' => 'Las páginas con códigos de error no pueden ser indexadas por los motores de búsqueda.',
                'hint'        => 'Asegúrese de que la página devuelva una respuesta 200 OK.',
                'hint_redirect' => 'Considere consolidar las redirecciones para reducir la latencia.',
            ],
            'html-size' => [
                'title'       => 'Tamaño HTML dentro del límite',
                'description' => 'Los documentos HTML muy grandes ralentizan el análisis y desperdician presupuesto de rastreo.',
                'hint'        => 'Elimine el marcado innecesario, scripts inline o datos inline del HTML.',
            ],
            'image-size' => [
                'title'       => 'Sin imágenes sobredimensionadas',
                'description' => 'Las imágenes grandes perjudican el LCP y aumentan el peso de la página.',
                'hint'        => 'Comprima las imágenes y sírvelas en formatos modernos (WebP, AVIF).',
            ],
            'js-size' => [
                'title'       => 'Sin archivos JavaScript sobredimensionados',
                'description' => 'Los bundles JS grandes retrasan el Time to Interactive.',
                'hint'        => 'Divida los bundles grandes con manualChunks de Vite o imports dinámicos.',
            ],
            'css-size' => [
                'title'       => 'Sin archivos CSS sobredimensionados',
                'description' => 'Las hojas de estilo grandes bloquean el renderizado. (Umbral predeterminado 15 KB — ajustable.)',
                'hint'        => 'Elimine el CSS no utilizado con la config content de Tailwind y active la compresión.',
            ],
            'compression' => [
                'title'       => 'Respuesta comprimida',
                'description' => 'Servir HTML sin compresión gzip o Brotli desperdicia ancho de banda.',
                'hint'        => 'Active la compresión gzip o Brotli en su servidor web o CDN.',
            ],
            'llms-txt' => [
                'title'       => 'llms.txt presente y bien formado',
                'description' => 'Un archivo /llms.txt ofrece a los agentes de IA un mapa conciso y legible por máquina de tu sitio.',
                'hint'        => 'Publica un /llms.txt en markdown con un título H1, un resumen breve y enlaces a las páginas clave.',
            ],
            'ai-bots-allowed' => [
                'title'       => 'Agentes de IA autorizados a rastrear',
                'description' => 'robots.txt bloquea rastreadores de IA conocidos: los agentes no pueden leer tu contenido.',
                'hint'        => 'Elimina el Disallow raíz para los user-agents de IA en robots.txt, salvo que los bloquees a propósito.',
            ],
            'sitemap-declared' => [
                'title'       => 'Sitemap detectable',
                'description' => 'Los agentes se apoyan en un sitemap para descubrir tus páginas de forma eficiente.',
                'hint'        => 'Añade una directiva Sitemap: a robots.txt o expón un /sitemap.xml accesible.',
            ],
            'accessible-names' => [
                'title'       => 'Elementos interactivos con nombres accesibles',
                'description' => 'Los agentes actúan mediante el árbol de accesibilidad; los controles sin nombre les resultan inutilizables.',
                'hint'        => 'Da a cada enlace, botón y campo de formulario un texto, un aria-label o un title.',
            ],
            'layout-stability' => [
                'title'       => 'Diseño estable (CLS)',
                'description' => 'El contenido que se desplaza durante la carga altera las coordenadas donde hacen clic los agentes.',
                'hint'        => 'Reserva espacio para imágenes, embeds y contenido dinámico para mantener bajo el CLS.',
            ],
            'webmcp-available' => [
                'title'       => 'Herramientas WebMCP expuestas',
                'description' => 'WebMCP permite que los agentes llamen a tu página como herramientas en lugar de scrapear la interfaz.',
                'hint'        => 'Registra herramientas con navigator.modelContext.registerTool o anota elementos de forma declarativa.',
            ],
            'webmcp-forms' => [
                'title'       => 'Formularios que exponen WebMCP declarativo',
                'description' => 'Los formularios anotados permiten a un agente enviarlos de forma fiable, sin adivinar los campos.',
                'hint'        => 'Añade anotaciones WebMCP declarativas a tus formularios para que los agentes los operen.',
            ],
            'webmcp-schema' => [
                'title'       => 'Las herramientas WebMCP declaran un esquema de entrada',
                'description' => 'Las herramientas sin esquema de entrada son difíciles de invocar correctamente para un agente.',
                'hint'        => 'Da a cada herramienta WebMCP registrada un inputSchema que describa sus parámetros.',
            ],
        ],
    ],
    'self_check' => [
    ...
    'nav' => [
        'issues'           => 'Problemas',
        'seo'              => 'SEO',
        'group_audit'      => 'Resultados de auditoría',
        'group_telemetry'  => 'Telemetría en vivo',
        'group_reference'  => 'Referencia',
    ],
    'pages' => [
        'overview' => [
            'title'    => 'Vitals',
    ...
    'url_detail' => [
        ...
        'link_latest_audit'      => 'Última auditoría',
        'link_seo'               => 'Checks SEO',
        'link_queries'           => 'Consultas BD',
        'link_rum'               => 'Rendimiento live',
    ],
    'insights' => [
    ...
    'issue_detail' => [
        ...
        'n_plus_one_banner'    => 'Los patrones N+1 repiten las mismas consultas SQL muchas veces por petición. Ver patrones por ruta y URLs afectadas en Consultas BD.',
        'n_plus_one_cta'       => 'Ver consultas BD',
    ],
    'budgets_page' => [
