                    ...
                    <div id="{{ $entry['key'] }}" class="border-l-4 border-{{ $sevColor }}-500 pl-4 py-1">
                        ...
                        @if ($entry['docs'])
                            <div class="mt-3 flex items-start gap-2 text-sm">
                                ...
                                <p class="text-zinc-700 dark:text-zinc-300">{{ $entry['docs']['why'] }}</p>
                            </div>
                                ...
                                <div class="mt-3 grid grid-cols-1 lg:grid-cols-2 gap-3">
                                    ...
                                    @if (! empty($entry['docs']['bad']))
                                        <div class="rounded-2xl border border-rose-200/60 dark:border-rose-900/40 bg-rose-50/40 dark:bg-rose-900/10 overflow-hidden">
                                            ...
                                            <pre class="p-3 text-[11px] leading-snug overflow-x-auto"><code class="text-rose-800 dark:text-rose-200">{{ $entry['docs']['bad'] }}</code></pre>
                                        </div>
                                    @endif
                                </div>
                            @endif
